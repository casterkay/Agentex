# OpenClaw Kubernetes Cluster

Source: https://docs.openclaw.ai/install/kubernetes

Use this as the local deployment reference for the Agentex four-agent demo.
...
For the Agentex demo, deploy four isolated OpenClaw instances:
